...
if (isset($_GET['send'])) {
    ...
    if (is_file($path)) {
        ...
        if (in_array($extension, array('txt'))) {
            ...
            header('Content-Disposition: inline; filename="' . basename($path) . '"');
        } else if (in_array($extension, array('pdf', 'doc', 'docx', 'odt', 'xls', 'xlsx', 'ods'))) {
